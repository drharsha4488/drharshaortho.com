...
import { additionalLocationPages } from '@/data/locationPages3';
      ...
      <section className="section-padding bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="container-medical text-center">
          ...
          <p className="text-white/90 max-w-2xl mx-auto mb-8">
            Schedule your consultation with Dr. B Harsha Vardhana Reddy at Apollo Hospitals, Financial District, Hyderabad.
          </p>
