    ...
    const fetchBlogPosts = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const uniqueAutoBlogs = autoGeneratedBlogs.filter(p => !apiPostIds.includes(p.slug));
          setBlogPosts([...data, ...uniqueAutoBlogs, ...uniqueNewPosts, ...uniqueSEOPosts, ...uniqueStaticPosts]);
        } else {
          // Fallback to static + SEO posts
          setBlogPosts([...autoGeneratedBlogs, ...seoBlogPosts, ...staticBlogPosts]);
        }
      } catch (err) {
