...
const SchemaMarkup = ({ type, data, faqs }) => {
  ...
  const organizationSchema = {
    ...
    "url": "https://ortho-excellence-1.preview.emergentagent.com",
    "logo": "https://ortho-excellence-1.preview.emergentagent.com/images/dr-harsha-logo.png",
    "image": "https://ortho-excellence-1.preview.emergentagent.com/images/dr-harsha-profile-optimized.jpg",
  ...
  const physicianSchema = {
    ...
    "image": "https://ortho-excellence-1.preview.emergentagent.com/images/dr-harsha-profile-optimized.jpg",
    "url": "https://ortho-excellence-1.preview.emergentagent.com/about",
    "telephone": "+91-99599-64567",
  ...
  const articleSchema = type === 'Article' && data ? {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://ortho-excellence-1.preview.emergentagent.com/images/dr-harsha-logo.png"
      }
    },
